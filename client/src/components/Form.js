      ...
      {!isDisabled && (
        <Box padding='2rem 2rem 1rem 2rem'>
          ...
          <Typography variant="body1" gutterBottom className={classes.mt1}>
            Need help with your self isolation plan? {window.innerWidth < 600 && <br />}<a className={classes.isPrimary} href="https://www2.gov.bc.ca/gov/content/safety/emergency-preparedness-response-recovery/covid-19-provincial-support">Talk to a Service BC agent</a>
          </Typography>
          <Typography variant="body1" gutterBottom className={classes.mt1}>
