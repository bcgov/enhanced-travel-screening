    ...
    <Fragment>
      <Card>
        <Box textAlign="center" padding="1rem">
          ...
          <p>
            <Button className={classes.contactButton} color="primary" variant="outlined">Text&nbsp;<a className={classes.primaryText} href="tel:+16046300300">1-604-630-0300</a></Button>
          </p>
          <p>
