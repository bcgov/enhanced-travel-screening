...
const LookupConfirmationNumber = lazy(() =>
  import("./pages/private/LookupConfirmationNumber")
);
      ...
      <BrowserRouter>
        <Suspense fallback={<LinearProgress />}>
          <Switch>
            ...
            <h1 style={{ "font-size": "1vw", textAlign: "center" }}>
              Please visit 
              <a
                href={
              ...
              >
               <br></br><br></br> https://www2.gov.bc.ca/gov/content/covid-19/travel/current  <br></br><br></br>
              </a>
